...
def videowriter(left_image,right_image):
...
#        return render_template('index.html', img='https://snaps.yacomink.com/' + k.key)
    ...
    for i in range(0, frames):
        over_left = getPageSizedImage(SimpleCV.Image(left_image));
        over_right = getPageSizedImage(SimpleCV.Image(right_image));
